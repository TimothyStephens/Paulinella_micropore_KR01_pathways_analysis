...
Fasta.file <- "Paulinella_micropora_KR01_nuclear.assembly.fasta"
Bam.file <- "All_combined.HISAT2_RNAseq_mapping.coordSorted.bam"

#Annot.file.domains <- ""
#Annot.name.domains <- "PFAM Domain"
